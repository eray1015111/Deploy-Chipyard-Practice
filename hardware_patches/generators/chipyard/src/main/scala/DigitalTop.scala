...
class DigitalTop(implicit p: Parameters) extends ChipyardSystem
  ...
  with chipyard.example.CanHavePeripheryMAC // Enables optionally adding the MAC accelerator
  with chipyard.example.CanHavePeripheryLFSR
  with chipyard.example.CanHavePeripheryLFSRDMA // Enables optionally adding the LFSR accelerator
